...
if base_package_version == '0.3.1':
    ...
    from .vllm_v_0_6_3.llm import LLMEngine
    from .vllm_v_0_6_3 import parallel_state
elif base_package_version is not None and vs.parse(base_package_version) >= vs.parse('0.7.0'):
